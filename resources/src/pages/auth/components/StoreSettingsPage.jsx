...
const StoreSettingsPage = () => {
    ...
    const [storeData, setStoreData] = useState({
        ...
        tagline: "Premium FiveM Items & Vehicles",
        ...
        // SEO & Analytics
        seo: {
            meta_title: "Los Santos Roleplay Store - Premium FiveM Items",
            meta_description: "Shop premium FiveM items, vehicles, and exclusive content for Los Santos Roleplay server.",
            keywords: "fivem, roleplay, vehicles, weapons, items, los santos",
            google_analytics: "",
            facebook_pixel: ""
        },
    ...
    const settingsTabs = [
        ...
        { id: "seo", label: "SEO & Analytics", icon: <TrendingUp className="w-5 h-5" /> },
        { id: "legal", label: "Legal & Compliance", icon: <Shield className="w-5 h-5" /> }
    ];
            ...
            >
                <div>
                    ...
                    <p className="text-gray-400 font-mono">
                        Configure your store appearance, features, and settings
                    </p>
                </div>
                ...
                <div className="col-span-1">
                    ...
                    >
                        ...
                        <div className="mt-8 space-y-3">
                            <h3 className="text-cyan-400 font-mono font-bold text-sm">QUICK_STATS</h3>
                            <div className="bg-gray-800/30 p-3 rounded-lg">
                                <div className="text-emerald-400 font-mono font-bold">99.8%</div>
                                <div className="text-gray-400 text-xs">Uptime</div>
                            </div>
                            <div className="bg-gray-800/30 p-3 rounded-lg">
                                <div className="text-cyan-400 font-mono font-bold">247</div>
                                <div className="text-gray-400 text-xs">Active Users</div>
                            </div>
                            <div className="bg-gray-800/30 p-3 rounded-lg">
                                <div className="text-yellow-400 font-mono font-bold">4.8★</div>
                                <div className="text-gray-400 text-xs">Store Rating</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
